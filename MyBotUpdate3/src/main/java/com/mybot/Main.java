...
public class Main {
    public static void main(String[] args) {
        System.out.println("🚀 Запуск погодного бота v3.0...");
        System.out.println("==============================");
        System.out.println("✨ Новая функция: Инлайн-режим!");
        System.out.println("💬 Наберите @" + BotConfig.BOT_USERNAME + " Москва в любом чате");
        System.out.println("==============================");
        ...
        try {
            ...
            System.out.println("💬 Инлайн-режим доступен в любом чате!");
            System.out.println("==============================");
