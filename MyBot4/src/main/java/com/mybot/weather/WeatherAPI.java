...
public class WeatherAPI {
    ...
    public WeatherAPI() {
        ...
        System.out.println("✅ WeatherAPI инициализирован. Кэш: " + (useCache ? "ВКЛ" : "ВЫКЛ"));
    }
    ...
    public WeatherData getWeather(String cityName) throws Exception {
        ...
        if (useCache && weather != null) {
            ...
            System.out.println("💾 Данные сохранены в кэш для: " + cityName);
        }
    ...
    // НОВЫЙ МЕТОД: Прямое сохранение в кэш
    public void cacheWeather(String city, WeatherData weatherData) {
        if (useCache && weatherData != null) {
            cache.put(city, weatherData);
            System.out.println("💾 Явное сохранение в кэш для: " + city);
        }
    }
